...
if st.button("Predict"):
            ...
            if predict[0] == 1:
                st.markdown("<h3 style='text-align: center;'>Loan Is Approved</h3>", unsafe_allow_html=True)
            else:
                st.markdown("<h3 style='text-align: center;'>Loan Is Rejected</h3>", unsafe_allow_html=True)